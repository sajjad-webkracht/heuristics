        ...
        <div>
            ...
            <div className='flex absolute z-30 top-0 left-0 h-svh'>
                <div className='w-2/3 px-24 py-12 2xl:pt-20'>
                    <h2 className='bg-ann-500 flex px-5 py-2 2xl:p-8 text-4xl font-bold mb-5 relative 2xl:text-5xl'>06 - Recognition Rather than Recall <animated.div className='h-full bg-ann-500 absolute top-0 left-0' style={ani1} /></h2>
